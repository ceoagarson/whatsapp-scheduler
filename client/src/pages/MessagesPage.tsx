            ...
            {messages && messages.map((message, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>{moment(new Date(new Date(message.next_run_date.setMonth(message.next_run_date.getMonth() - 1)))).format('MMMM Do YYYY, h:mm:ss a')}</td>
                  <td>{moment(new Date(new Date(message.next_refresh_date.setMonth(message.next_refresh_date.getMonth() - 1)))).format('MMMM Do YYYY, h:mm:ss a')}</td>
